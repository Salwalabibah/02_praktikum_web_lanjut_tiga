...
<body>
    ...
    <div class="container px-4 px-lg-5">
        <div class="row row-cols-1 row-cols-md-1 g-4">
            ...
            <a href="/program/thrift" class="col categoryName">
              <div class="card h-100" style="background-color: rgba(255, 221, 158, 0.781);">
                  <h5 class="card-title text-center">Thrift</h5>
              </div>
            </a>
            <a href="/program/jual baju" class="col categoryName">
              <div class="card h-100" style="background-color: rgba(255, 120, 120, 0.781);">
                  <h5 class="card-title text-center">Jual Baju</h5>
              </div>
            </a>
        </div>
    </div>
